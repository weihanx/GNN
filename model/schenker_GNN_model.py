...
from model.layers.GNN_cluster import GNN_Cluster, FiedlerClusterer
...
class GroupMat(torch.nn.Module):
    def __init__(self, num_feature=111, embedding_dim=32, hidden_dim=64, num_classes=15, device=DEVICE):
        ...
        self.gnn_cluster1 = FiedlerClusterer(embedding_dim, hidden_dim, num_classes, device=self.device)
